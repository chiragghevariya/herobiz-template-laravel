...
@section('content')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title"> Managed Portfolio </h1>
                <hr>
                <div class="">
                    <a href="{{ route('portfolio.create') }}" class="btn btn-info  btn-rounded btn-fw mdi mdi-plus">Add New</a>
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('portfolio.Singlestatuschange') }}",
                                data: {
                                    "status": status,
                                    "id": id,
                                    "_token": "{{ csrf_token() }}"
