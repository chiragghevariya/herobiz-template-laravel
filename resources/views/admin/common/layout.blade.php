        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
                <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
                    <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="{{ route('admin') }}"><img
                            ...
                            <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list"
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ asset('admin-asset/assets/images/faces/face4.jpg') }}" alt="" class="profile-pic" />
                                    </div>
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ asset('admin-asset/assets/images/faces/face3.jpg') }}" alt="" class="profile-pic" />
                                    </div>
                                    <div class="preview-item-content">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ asset('admin-asset/assets/images/faces/face2.jpg') }}" alt="" class="profile-pic" />
                                    </div>
                                    <div class="preview-item-content">
