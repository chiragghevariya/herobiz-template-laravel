...
@section('content')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title"> Managed Categories </h1>
                <hr>
                <div class="table-responsive">
                    <a href="{{ route('categories.create') }}" class="btn btn-info  btn-rounded btn-fw mdi mdi-plus">Add New</a>
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('categories.Singlestatuschange') }}",
                                data: {
                                    "status": status,
                                    "id": id,
                                    "_token": "{{ csrf_token() }}"
